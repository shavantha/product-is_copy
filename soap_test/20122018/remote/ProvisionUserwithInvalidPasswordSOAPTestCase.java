...
public class ProvisionUserwithInvalidPasswordSOAPTestCase extends SOAPTestBase {
    ...
    private String USER_PASSWORD = "wel";
    ...
    private String EXPECTED_MESSAGE = "Credential is not valid.";
    private static String ERROR_CODE = "30003";
    ...
    public void testAddUser()throws Exception {
        ...
        try {
            ...
            assertEquals(actualError.substring(36, 60), EXPECTED_MESSAGE, "The password is valid");
