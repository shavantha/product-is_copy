...
public class ProvisionSOAPUserwithoutUserNameTestCase extends SOAPTestBase {
    ...
    private String EXPECTED_MESSAGE = "Username null is not valid";
    private String ERROR_CODE = "31301";
    ...
    public void testAddUser()throws Exception {
        ...
        try{
               soapTestBase.provisionNewUser(USER_NAME, USER_PASSWORD, userRoleList, claims,
                       "default", false);
        } catch (AxisFault axisFault) {
            String actualError = axisFault.toString();

            assertEquals(actualError.substring(36,62),EXPECTED_MESSAGE,"The user name is valid");
            assertEquals(actualError.substring(28,33),ERROR_CODE,"expected error code not received");
        }
