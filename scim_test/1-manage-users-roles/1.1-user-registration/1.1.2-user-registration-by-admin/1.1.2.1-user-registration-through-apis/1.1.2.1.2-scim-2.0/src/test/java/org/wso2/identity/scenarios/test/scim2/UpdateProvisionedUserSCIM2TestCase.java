...
public class UpdateProvisionedUserSCIM2TestCase extends SCIMProvisioningTestBase {
    ...
    private String NEW_NAME = "newfirst";
    private String NEW_LAST_NAME = "newfamily";
    private String fileName = "provision.json";
    private String updatesFie = "updates.json";
    ...
    public void testUpdateUser() throws Exception {
        ...
        ProcessJsonFile.readFile(updatesFie);
        responseObj = getJSONFromResponse(this.response);
        userId = responseObj.get(SCIMConstants.ID_ATTRIBUTE).toString();

        updateURL = backendURL + SEPARATOR  + SCIMConstants.SCIM2_USERS_ENDPOINT + SEPARATOR +
    ...
    public static HttpResponse updateUserRequest(HttpClient client, String url, JSONObject jsonObject, Header[] headers)
            throws IOException {
