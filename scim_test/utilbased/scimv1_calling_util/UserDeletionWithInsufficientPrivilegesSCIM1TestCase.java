...
public class UserDeletionWithInsufficientPrivilegesSCIM1TestCase extends ScenarioTestBase {
    ...
    public void addMemberToRole() throws Exception {
       ...
       groupId =groupResponse.substring(213,249);
        ...
        groupObject.put(SCIMConstants.SCHEMAS_ATTRIBUTE, schemas);
        groupObject.put(SCIMConstants.ROLE_DISPLAY_NAME_ATTRIBUTE, SCIMConstants.ROLE_NAME);
