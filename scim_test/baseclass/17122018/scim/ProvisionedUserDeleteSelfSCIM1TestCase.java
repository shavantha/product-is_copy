...
public class ProvisionedUserDeleteSelfSCIM1TestCase extends SCIMProvisioningTestBase {
    ...
    public void addMemberToRole() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            member.put(SCIMConstants.DISPLAY, ProcessJsonFile.getJsonObject().get("userName").toString());
    ...
    public void testDeleteSelf() throws Exception {
        ...
        userEndPoint = backendURL + SEPARATOR  + Constants.SCIMEndpoints.SCIM1_ENDPOINT + SEPARATOR +
        ...
        assertEquals(response.getStatusLine().getStatusCode(), HttpStatus.SC_UNAUTHORIZED, "User has not been " +
